...
const Contact = ({ data }) => {
   const [url, setUrl] = useState('mailto:aaravmahajan7.am@gmail.com?subject=subject&body=body');
            ...
            <div className="eight columns">
               ...
               <form id="contactForm" name="contactForm">
                  ...
                  <div>
                     ...
                     <textarea value={message} onChange={e => setMessage(e.target.value)} cols="30" rows="3" id="contactMessage" name="contactMessage"></textarea>
                  </div>
